...
module.exports = async (client, guild) => {
        client.channels.get("508756287392186379").send(`j'ai quitté le serveur ${guild.name}[${guild.id}] dirigé par: ${guild.owner.user.tag} ayant ${guild.members.size} membres!`)
