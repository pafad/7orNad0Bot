...
//online
client.on('ready', ()=> {
    client.user.setPresence({game:{name:`${config.prefix}help by ${client.users.find("id", config.adminID).tag} sur ${client.guilds.size} serveurs`,url: "https://www.twitch.tv/discordapp",type}})
